...
export async function buyListingByAcceptedOffer(contract: ethers.Contract, offerId: string, priceInWei: string) {
    try {
        const buyListingByAcceptedOfferReceipt = await contract.buyListingByAcceptedOffer(offerId, {value: priceInWei});
